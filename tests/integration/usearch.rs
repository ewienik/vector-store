...
async fn simple_create_search_delete_index() {
    ...
    let index = IndexMetadata {
        ...
        target_name: "embeddings".to_string().into(),
        dimensions: NonZeroUsize::new(3).unwrap().into(),
        connectivity: 0.into(),
        expansion_add: 0.into(),
        expansion_search: 0.into(),
    ...
    db.add_table(
        ...
        Table {
            dimensions: [(index.target_name.clone(), index.dimensions)]
                .into_iter()
                .collect(),
        },
    )
    ...
    db.add_index(
        ...
        Index {
            ...
            target_name: index.target_name.clone(),
